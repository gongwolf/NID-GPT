# Training CTGAN and Sampling Synthetic Flow Data on the UNSW-NB15 Dataset
...
# Training CTGAN and Sampling Synthetic Flow Data on the CICIDS2017 Dataset
...
# Training CTGAN and Sampling Synthetic Flow Data on the CICDDOS2019 Dataset
